...
理论上来说，掌握了基本的语法和核心库，你就可以开发任何程序了。但在实践中，为了避免重新发明“轮子”，减少不必要的工作量，我们还会用到大量的第三方类库，比如，[Google Guava](https://github.com/google/guava)、[SLF4J](http://www.slf4j.org) 等等。
...
![](/assets/pages/work-method/32.jpg)
