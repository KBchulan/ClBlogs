...
因此为了解决这种需求，我们常用的方式有 [sse](https://kbchulan.github.io/ClBlogs/blogs-main/mystore/01-sse.html)，websocket，[WebTransport](https://developer.mozilla.org/en-US/docs/Web/API/WebTransport)等等方式，本节我们介绍一下其中全双工的协议：**websocket**。
