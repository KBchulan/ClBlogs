...
[promise](https://en.cppreference.com/w/cpp/thread/promise.html)是本节中最底层最灵活的板块，它提供了一种在线程间传递值的机制，核心作用是 **提供一个可以被手动兑现的承诺**，当创建了一个 promise，就类似于向整个程序宣告：未来我会提供一个值，来订阅我把。
