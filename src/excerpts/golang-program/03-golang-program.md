...
## 安装和配置 IAM 系统
要想完成 IAM 系统的安装，我们还需要安装和配置 iam-apiserver、iam-authz-server、iam-pump 和 iamctl。这些组件的功能我们在[第1讲](https://kbchulan.github.io/ClBlogs/excerpts/golang-program/01-golang-program.html)详细讲过，如果不记得你可以翻回去看看。
...
![](/assets/pages/golang-program/3-1.png)
...
![](/assets/pages/golang-program/3-2.png)
...
![](/assets/pages/golang-program/3-3.jpg)
...
## 彩蛋：一键安装
如果学完了[第02讲](https://kbchulan.github.io/ClBlogs/excerpts/golang-program/01-golang-program.html)，你可以直接执行如下脚本，来完成 IAM 系统的安装：
