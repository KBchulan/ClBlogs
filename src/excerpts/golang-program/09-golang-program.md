...
![](/assets/pages/golang-program/9-1.png)
...
![](/assets/pages/golang-program/9-2.png)
...
![](/assets/pages/golang-program/9-3.png)
...
![](/assets/pages/golang-program/9-4.png)
...
![](/assets/pages/golang-program/9-5.png)
...
![](/assets/pages/golang-program/9-6.png)
...
最后，关于如何管理应用的生命周期，我给出了一些建议：**研发模式建议选择敏捷模式**，因为它更能胜任互联网时代快速迭代的诉-求。DevOps则要**优先确保落地CI/CD技术**，接着尝试落地ChatOps技术，如果有条件可以积极探索AIOps和GitOps。
