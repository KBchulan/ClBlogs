...
![](/assets/pages/golang-program/5-1.png)
...
![](/assets/pages/golang-program/5-2.png)

再来看一个完整的符合 Angular 规范的 Commit Message，如下图所示：

![](/assets/pages/golang-program/5-3.png)
...
![](/assets/pages/golang-program/5-4.png)

有这么多 type，我们该如何确定一个 commit 所属的 type 呢？这里我们可以通过下面这张图来确定。

![](/assets/pages/golang-program/5-5.png)
...
![](/assets/pages/golang-program/5-6.png)
...
![](/assets/pages/golang-program/5-7.png)
...
![](/assets/pages/golang-program/5-8.png)

修改完成后执行`:wq` 保存，会跳转到一个新的交互页面，在该页面，我们可以编辑 Commit Message，编辑后的内容如下图所示：

![](/assets/pages/golang-program/5-9.png)
...
![](/assets/pages/golang-program/5-10.png)
...
![](/assets/pages/golang-program/5-11.png)

修改完成后执行`:wq` 保存，还会跳转到一个新的交互页面，如下图所示：

![](/assets/pages/golang-program/5-12.png)
...
![](/assets/pages/golang-program/5-13.png)
