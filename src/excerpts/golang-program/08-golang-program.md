---
title: 08 研发流程设计（上）：如何设计 Go 项目的开发流程？
article: true
...
![](/assets/pages/golang-program/8-1.png)
...
这里有个点我们一定要注意：研发流程也是一种规范，很难靠开发者的自觉性去遵守。为了让项目参与人员尽可能地遵守规范，需要借助一些工具、系统来对他们进行强约束。所以，在我们设计完整个研发流程之后，需要认真思考下，有哪些地方可以实现自动化，有哪些地方可以靠工具、系统来保障规范的执行。这些自动化工具会在 **第 16 讲** 中详细介绍。
...
![](/assets/pages/golang-program/8-2.png)
...
![](/assets/pages/golang-program/8-3.png)
...
![](/assets/pages/golang-program/8-4.png)
...
![](/assets/pages/golang-program/8-5.png)
...
![](/assets/pages/golang-program/8-6.png)

具体分工如下表所示。

![](/assets/pages/golang-program/8-7.png)
...
![](/assets/pages/golang-program/8-8.png)
