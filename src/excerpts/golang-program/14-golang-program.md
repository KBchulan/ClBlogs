...
我们在 [第10讲](https://kbchulan.github.io/ClBlogs/excerpts/golang-program/10-golang-program.html) 学习过，要写出一个优雅的Go项目，不仅仅是要开发一个优秀的Go应用，而且还要能够高效地管理项目。有效手段之一，就是通过Makefile来管理我们的项目，这就要求我们要为项目编写Makefile文件。
...
![](/assets/pages/golang-program/14-1.png)
